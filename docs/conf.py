...
# -*- coding: utf-8 -*-
#
# lox documentation build configuration file, created by
...
latex_documents = [
    (master_doc, "lox.tex", "lox Documentation", "Brian Pugh", "manual"),
]
...
man_pages = [(master_doc, "lox", "lox Documentation", [author], 1)]
